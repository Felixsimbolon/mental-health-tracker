...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","https://jeremi-felix-newmentalhealthtracker.pbp.cs.ui.ac.id", "https://jeremi-felix-newmentalhealthtracker.pbp.cs.ui.ac.id"]
